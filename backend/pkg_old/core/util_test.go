...
func (m *mockEntity) GetCurrentEventContext() *EventContext            { return nil }
func (m *mockEntity) PushEventContext(ctx *EventContext)               {}
func (m *mockEntity) LogEvent(eventType interface{}, data interface{}) {}
...
func (entityStub) MakeSavingThrow(ability Ability, targetValue int, isSpell bool, damageType DamageType, simOptions *SimulationOptions) (RollResult, error) {
	return nil, nil
}
...
func (entityStub) ModifyHP(value int, isTemp bool, tempStacking bool, allowMassiveDamage bool, damageType DamageType, isCritical bool) (HPModificationResult, error) {
	return nil, nil
}
...
func (entityStub) GetEntityType() EntityType                        { return "" }
func (entityStub) PushEventContext(ctx *EventContext)               {}
func (entityStub) GetCurrentEventContext() *EventContext            { return nil }
