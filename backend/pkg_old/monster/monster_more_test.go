...
func newSeededMonster(t *testing.T) *Monster {
	...
	m.ActionManager = &MonsterActionManager{}
	m.AI = NewMonsterAI(m, nil)
	m.PushEventContext(&core.EventContext{})
...
func TestLegendaryAction_NoPoints_RemainsZero(t *testing.T) {
	...
	act := Action{
		...
		DamageBlocks: []core.DamageBlock{
			{NumberOfDice: 1, Die: core.D6, DamageType: core.DamageSlashing, Modifier: 1},
		},
		AttackBonus: 5,
	}
...
func TestSetHP_InvalidMethod_ReturnsError(t *testing.T) {
	m := newSeededMonster(t)
	if err := m.SetHP(core.HPMethodType(255), 5); err == nil {
...
func TestSetEventListener_EmitsOnInitializeHP(t *testing.T) {
	...
	m.HP = core.HPConfig{HPMethod: core.HPSetValue, Value: 9, HitDie: core.D8}
