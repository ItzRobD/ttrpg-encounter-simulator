...
func GetSpellSummaries(ctx context.Context) (map[int]SpellSummary, error) {
	summaries := make(map[int]SpellSummary)
	var err error
...
func GetSpellSummariesByClassID(ctx context.Context, classID uint8) (map[int]SpellSummary, error) {
	summaries := make(map[int]SpellSummary)
