...
import { ActorActions } from './actor-actions.component';
import { Monster, MonsterType, MonsterSize, DamageType, DiceType } from '../../models';

describe('ActorActions', () => {
  let component: ActorActions;
  let fixture: ComponentFixture<ActorActions>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ActorActions]
    })
    .compileComponents();

    fixture = TestBed.createComponent(ActorActions);
