...
import { ActorSpecialAbilities } from './actor-special-abilities.component';
import { Monster, MonsterType, MonsterSize, DamageType, DiceType } from '../../models';

describe('ActorSpecialAbilities', () => {
  let component: ActorSpecialAbilities;
  let fixture: ComponentFixture<ActorSpecialAbilities>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ActorSpecialAbilities]
    })
    .compileComponents();

    fixture = TestBed.createComponent(ActorSpecialAbilities);
