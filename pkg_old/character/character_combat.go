...
func (c *Character) CreateAttackRequest(target core.Entity, slot core.WeaponSlot, useVersatile bool, simulationOptions *core.SimulationOptions) (*core.AttackRequest, error) {
	...
	attackOptions := core.AttackOptions{
		...
		PowerAttack:          false,
		ImprovedCritical:     (simulationOptions != nil && simulationOptions.UseImprovedCritical) || (c.Configuration.CombatFeatures.CriticalThreshold > 0 && c.Configuration.CombatFeatures.CriticalThreshold < 20),
