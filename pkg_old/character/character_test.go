...
func TestInitializeHP_Variants_ValueAverageRoll(t *testing.T) {
	...
	// Value
	ch.HPConfig = core.HPConfig{HPMethod: core.HPSetValue, Value: 15, HitDie: core.D8}
	...
	// Average
	ch.HPConfig = core.HPConfig{HPMethod: core.HPSetAverage, HPAverage: 12, HitDie: core.D8}
	if err := ch.InitializeHP(); err != nil {
	...
	ch.HPConfig = core.HPConfig{HPMethod: core.HPSetRoll, HitDie: core.D8, NumberOfDice: 1, AmountToAdd: 0}
	if err := ch.InitializeHP(); err != nil {
...
func TestCreateAttackRequest_PropagatesOptions(t *testing.T) {
	...
	req, err := ch.CreateAttackRequest(tgt, core.WSPrimary, false, &core.SimulationOptions{UseImprovedCritical: true})
	if err != nil {
...
func TestCreateWeaponAttackData_Modifiers(t *testing.T) {
	...
	rapier := &weapon.Weapon{
		...
		Properties: weapon.Properties{IsRanged: false, IsFinesse: true},
	}
