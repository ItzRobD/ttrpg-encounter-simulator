...
func TestSetHP_Variants_ValueAverageRoll(t *testing.T) {
	...
	// Value
	m.HP = core.HPConfig{HPMethod: core.HPSetValue, Value: 15, HitDie: core.D8}
	...
	// Average
	m.HP = core.HPConfig{HPMethod: core.HPSetAverage, HPAverage: 12, HitDie: core.D8}
	if err := m.InitializeHP(); err != nil {
	...
	m.HP = core.HPConfig{HPMethod: core.HPSetRoll, NumberOfDice: 2, HitDie: core.D8}
	if err := m.InitializeHP(); err != nil {
