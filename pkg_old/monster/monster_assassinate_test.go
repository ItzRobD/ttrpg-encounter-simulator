...
func (s *assassinateTargetStub) GetCurrentEventContext() *core.EventContext       { return nil }
func (s *assassinateTargetStub) PushEventContext(ctx *core.EventContext)          {}
func (s *assassinateTargetStub) LogEvent(eventType interface{}, data interface{}) {}
