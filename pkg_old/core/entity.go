...
type Entity interface {
	...
	GetHitDie() DiceType
	GetCasterLevel() int
	MakeSavingThrow(ability Ability, targetValue int, isSpell bool, damageType DamageType, simOptions *SimulationOptions) (RollResult, error)
...
type Combatant struct {
	Entity     Entity         `json:"-"`
	Info       *CombatantInfo `json:"info"`
	Initiative int            `json:"initiative"`
	IsLair     bool           `json:"is_lair"`
}
