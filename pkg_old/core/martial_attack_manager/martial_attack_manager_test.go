	...
	ad := []core.AttackData{
		{
			...
			AttackModifier: 5, DamageModifier: 3,
		},
		{
			Name: "Stab",
			DamageBlocks: []core.DamageBlock{
				{NumberOfDice: 2, Die: core.D6, DamageType: core.DamagePiercing},
			},
			AttackModifier: 4, DamageModifier: 2,
		},
	}
	...
	ad := []core.AttackData{
		{
			...
			AttackModifier: 3, DamageModifier: 0,
		},
	}
