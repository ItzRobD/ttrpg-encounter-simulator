...
type Lair struct {
	...
	ai            *LairAI
	listener      func(event interface{}) `json:"-"`
...
func (l *Lair) MakeSavingThrow(ability core.Ability, targetValue int, isSpell bool, damageType core.DamageType, simOptions *core.SimulationOptions) (core.RollResult, error) {
...
func (l *Lair) ModifyHP(value int, isTemp bool, tempStacking bool, allowMassiveDamage bool, damageType core.DamageType, isCritical bool) (core.HPModificationResult, error) {
